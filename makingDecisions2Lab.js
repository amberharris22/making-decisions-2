...
/*
  Use a for-loop to iterate through each number in the 'nums' array, if the number is even, 
  append it to the 'evensArr'.
*/
...
/*
  ...
  console log an 'A', between 80 and 89, console log a 'B', between 70 and 79, 'C', 
...
/*
  Create a variable named 'someNum' and set it equal to the fifth value of the 'myFavoriteNumbers' 
  array.
*/
...
// Subscripting (accessing values using their index) an array can fail. What happens if you 
// subscript to the 7th element, but there are not 7 elements in the array? Let's write some 
...
// (Hint: how can you make sure that your code works for exactly 7 elements? What index do you 
// use to get the 7th element?)

//Code Here
//if the index is not there it will say "undefined"
...
/* The famous FizzBuzz, Devmountain style!
  ...
  if the number your for loop is currently on is divisible by 3, console.log 'Dev'. If the 
  number is divisible by 5, console.log 'mountain'. If the number is divisible by 5 & 3, 
  console.log 'Devmountain'. If the number is not divisible by 5 or 3, console.log the number 
  itself. Hint: Look up the modulo operator.
